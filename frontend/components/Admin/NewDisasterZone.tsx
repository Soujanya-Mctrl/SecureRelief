...
<<<<<<< HEAD:frontend/src/components/Admin/NewDisasterZone.tsx
...
=======
import { errorHandler, handleError, showSuccess, showWarning } from '../../src/utils/errorHandler'
import { validator, validateDisasterZone, validateField } from '../../src/utils/validator'
import Modal from '../UI/Modal'
import Button from '../UI/Button'
import LoadingSpinner from '../UI/LoadingSpinner'
>>>>>>> 2d12a3048a2e4892ebddb69be5a8cffbcaebe0c9:frontend/components/Admin/NewDisasterZone.tsx

const NewDisasterZone = ({ isOpen, onClose, onSuccess }) => {
  const { isConnected, account, userRole } = useWeb3Store()
  const { createDisasterZone } = useContract()
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const blockchainResult = await createDisasterZone({
        name: formData.name,

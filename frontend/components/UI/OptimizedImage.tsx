...
<<<<<<< HEAD:frontend/src/components/UI/OptimizedImage.tsx
import { SkeletonCard as Skeleton } from '@/components/ui/Skeleton';
=======
import { SkeletonCard as Skeleton } from './Skeleton';
>>>>>>> 2d12a3048a2e4892ebddb69be5a8cffbcaebe0c9:frontend/components/UI/OptimizedImage.tsx
    ...
    <div className={`relative ${className}`}>
      ...
      {lowQualitySrc && (
        <img
          src={lowQualitySrc}
          alt=""
          className={`absolute inset-0 w-full h-full object-cover filter blur-sm transition-opacity duration-500 ${imageLoaded ? 'opacity-0' : 'opacity-100'
            }`}
